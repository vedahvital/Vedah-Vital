...
const stages = [
  { id: 1, time: '0 – 5 min',      title: 'Dissolution',  subtitle: 'Capsule breaks down in stomach',       detail: 'The vegetable cellulose capsule dissolves in stomach acid, releasing a precise 500 mg dose of KSM-66® root extract (delivering 30mg of active withanolides) alongside 5mg of piperine from Black Pepper extract.', color: '#A9C2E3', region: 'stomach' },
